...
const Rectangle = (props) => {
  return (
    ...
    <text x="104" y="40" fill="black" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="24">
    {props.text1}
    </text>

    <text x="104" y="100" fill="#FF8000" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="22">
    {props.text2}
    </text>

    <text x="104" y="150" fill="black" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="24">
    {props.text3}
    </text>
